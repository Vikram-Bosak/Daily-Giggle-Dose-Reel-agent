...
def run_upload(video_data):
    ...
    try:
        ...
        fb_caption = f"{headline}\n\n#funny #memes #comedy #bloopers"
        yt_title = title
        yt_desc = fb_caption
        yt_tags = ["funny", "memes", "comedy", "lol", "lmao"]
        
    video_data["description"] = fb_caption

    delay_seconds = random.randint(5, 10) # 5 to 10 seconds for testing
