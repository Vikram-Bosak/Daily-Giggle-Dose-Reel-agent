...
def search_and_download_latest_video():
    ...
    # Use environment variables if defined, otherwise fall back to funny video/meme profiles
    ...
    if env_profiles:
        ...
        profiles = [
            ...
            "https://x.com/Lmao",
            "https://x.com/pubity",
            "https://x.com/NoContextHumans",
            "https://x.com/crazyclipsonly",
            "https://x.com/Fails_Vids",
            "https://x.com/AnimalsNoContext",
            "https://x.com/TheFigen_",
            "https://x.com/daily_memes",
            "https://x.com/ContextFreeVids",
            "https://x.com/ComedyCentral",
            "https://x.com/MemeRestore",
            "https://x.com/Funnyhood",
            "https://x.com/WholesomeMeme",
            "https://x.com/lmao_memes_only",
            "https://x.com/ViralMemes",
            "https://x.com/DailyLoud",
            "https://x.com/DailyOutOfContx",
            "https://x.com/ShouldHaveHappen",
            "https://x.com/ViralDosePics"
        ]
    ...
    # 12 hours lookback to match the 2-hour schedule safely
